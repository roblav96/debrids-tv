		...
		export module futures {
			...
			export module CallbackToFutureAdapter {
				...
				export class Resolver<T>  extends java.lang.Object {
					...
					public constructor();
					public attachCompleter(completer0: androidx.concurrent.futures.CallbackToFutureAdapter.Completer<T>): any;
				}
	...
	export module concurrent {
		export module futures {
			export class DirectExecutor extends java.util.concurrent.Executor {
				...
				public static values(): native.Array<androidx.concurrent.futures.DirectExecutor>;
