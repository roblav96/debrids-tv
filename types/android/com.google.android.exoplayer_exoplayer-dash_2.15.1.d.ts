		...
		export module android {
			export module exoplayer2 {
				export module source {
					export module dash {
						export class BaseUrlExclusionList extends java.lang.Object {
							public static class: java.lang.Class<com.google.android.exoplayer2.source.dash.BaseUrlExclusionList>;
							public constructor();
							public static getPriorityCount(baseUrls: java.util.List<com.google.android.exoplayer2.source.dash.manifest.BaseUrl>): number;
							public selectBaseUrl(baseUrls: java.util.List<com.google.android.exoplayer2.source.dash.manifest.BaseUrl>): com.google.android.exoplayer2.source.dash.manifest.BaseUrl;
							public getPriorityCountAfterExclusion(baseUrls: java.util.List<com.google.android.exoplayer2.source.dash.manifest.BaseUrl>): number;
							public exclude(baseUrlToExclude: com.google.android.exoplayer2.source.dash.manifest.BaseUrl, exclusionDurationMs: number): void;
							public reset(): void;
						}
					}
				}
					...
					export module dash {
						...
						export module DashChunkSource {
							export class Factory extends java.lang.Object {
								 ...
								 */
								public constructor(implementation: {
									createDashChunkSource(loaderErrorThrower0: com.google.android.exoplayer2.upstream.LoaderErrorThrower, dashManifest1: com.google.android.exoplayer2.source.dash.manifest.DashManifest, baseUrlExclusionList2: com.google.android.exoplayer2.source.dash.BaseUrlExclusionList, int3: number, ints4: native.Array<number>, exoTrackSelection5: com.google.android.exoplayer2.trackselection.ExoTrackSelection, int6: number, long7: number, boolean8: boolean, list9: java.util.List<com.google.android.exoplayer2.Format>, playerTrackEmsgHandler10: com.google.android.exoplayer2.source.dash.PlayerEmsgHandler.PlayerTrackEmsgHandler, transferListener11: com.google.android.exoplayer2.upstream.TransferListener): com.google.android.exoplayer2.source.dash.DashChunkSource;
								});
								public constructor();
				...
				export module source {
					export module dash {
						export class DashUtil extends java.lang.Object {
							...
							public static loadSampleFormat(dataSource: com.google.android.exoplayer2.upstream.DataSource, trackType: number, representation: com.google.android.exoplayer2.source.dash.manifest.Representation, baseUrlIndex: number): com.google.android.exoplayer2.Format;
							...
							public static resolveCacheKey(representation: com.google.android.exoplayer2.source.dash.manifest.Representation, rangedUri: com.google.android.exoplayer2.source.dash.manifest.RangedUri): string;
							public static loadChunkIndex(dataSource: com.google.android.exoplayer2.upstream.DataSource, trackType: number, representation: com.google.android.exoplayer2.source.dash.manifest.Representation, baseUrlIndex: number): com.google.android.exoplayer2.extractor.ChunkIndex;
							public static loadInitializationData(chunkExtractor: com.google.android.exoplayer2.source.chunk.ChunkExtractor, dataSource: com.google.android.exoplayer2.upstream.DataSource, representation: com.google.android.exoplayer2.source.dash.manifest.Representation, loadIndex: boolean): void;
							public static buildDataSpec(representation: com.google.android.exoplayer2.source.dash.manifest.Representation, baseUrl: string, requestUri: com.google.android.exoplayer2.source.dash.manifest.RangedUri, flags: number): com.google.android.exoplayer2.upstream.DataSpec;
						}
					}
				}
			}
					...
					export module dash {
						...
						export module DefaultDashChunkSource {
							...
							export class RepresentationHolder extends java.lang.Object {
								...
								public selectedBaseUrl: com.google.android.exoplayer2.source.dash.manifest.BaseUrl;
		...
		export module android {
			export module exoplayer2 {
				export module source {
					export module dash {
						export module manifest {
							export class BaseUrl extends java.lang.Object {
								public static class: java.lang.Class<com.google.android.exoplayer2.source.dash.manifest.BaseUrl>;
								public static DEFAULT_PRIORITY: number;
								public static DEFAULT_WEIGHT: number;
								public url: string;
								...
								public equals(obj: any): boolean;
								public constructor(url: string, serviceLocation: string, priority: number, weight: number);
					...
					export module dash {
						export module manifest {
							export class DashManifestParser extends org.xml.sax.helpers.DefaultHandler implements com.google.android.exoplayer2.upstream.ParsingLoadable.Parser<com.google.android.exoplayer2.source.dash.manifest.DashManifest>  {
								...
								public parseRoleFlagsFromDashRoleScheme(value: string): number;
								...
								public parseBaseUrl(xpp: org.xmlpull.v1.XmlPullParser, parentBaseUrls: java.util.List<com.google.android.exoplayer2.source.dash.manifest.BaseUrl>): java.util.List<com.google.android.exoplayer2.source.dash.manifest.BaseUrl>;
								...
								public parsePeriod(xpp: org.xmlpull.v1.XmlPullParser, parentBaseUrls: java.util.List<com.google.android.exoplayer2.source.dash.manifest.BaseUrl>, defaultStartMs: number, baseUrlAvailabilityTimeOffsetUs: number, availabilityStartTimeMs: number, timeShiftBufferDepthMs: number): globalAndroid.util.Pair<com.google.android.exoplayer2.source.dash.manifest.Period,java.lang.Long>;
								...
								public parseMediaPresentationDescription(xpp: org.xmlpull.v1.XmlPullParser, documentBaseUrl: com.google.android.exoplayer2.source.dash.manifest.BaseUrl): com.google.android.exoplayer2.source.dash.manifest.DashManifest;
								...
								public parseSelectionFlagsFromDashRoleScheme(value: string): number;
							...
							export module DashManifestParser {
								export class RepresentationInfo extends java.lang.Object {
									...
									public baseUrls: com.google.common.collect.ImmutableList<com.google.android.exoplayer2.source.dash.manifest.BaseUrl>;
						...
						export module manifest {
							...
							export module Representation {
								export class MultiSegmentRepresentation extends com.google.android.exoplayer2.source.dash.manifest.Representation implements com.google.android.exoplayer2.source.dash.DashSegmentIndex {
									...
									public getSegmentCount(periodDurationUs: number): number;
									public getAvailableSegmentCount(periodDurationUs: number, nowUnixTimeUs: number): number;
									public constructor(revisionId: number, format: com.google.android.exoplayer2.Format, baseUrls: java.util.List<com.google.android.exoplayer2.source.dash.manifest.BaseUrl>, segmentBase: com.google.android.exoplayer2.source.dash.manifest.SegmentBase.MultiSegmentBase, inbandEventStreams: java.util.List<com.google.android.exoplayer2.source.dash.manifest.Descriptor>);
									public getCacheKey(): string;
									public getDurationUs(segmentNum: number, periodDurationUs: number): number;
									public getIndex(): com.google.android.exoplayer2.source.dash.DashSegmentIndex;
									public getFirstAvailableSegmentNum(periodDurationUs: number, nowUnixTimeUs: number): number;
