	...
	export module media2 {
		export module session {
			export class MediaConstants extends java.lang.Object {
				...
				public static MEDIA_URI_PATH_SET_MEDIA_URI: string;
				public static MEDIA_URI_QUERY_ID: string;
				public static MEDIA_URI_QUERY_QUERY: string;
				public static MEDIA_URI_QUERY_URI: string;
			}
		}
	}
}
	...
	export module media2 {
		export module session {
			...
			export module MediaControllerImplLegacy {
				...
				export class SetMediaUriRequest extends java.lang.Object {
					public static class: java.lang.Class<androidx.media2.session.MediaControllerImplLegacy.SetMediaUriRequest>;
					public type: string;
					public value: string;
					public extras: globalAndroid.os.Bundle;
					public result: androidx.concurrent.futures.ResolvableFuture<androidx.media2.session.SessionResult>;
				}
			}
		}
	}
			...
			export module MediaLibraryService {
				...
				export module MediaLibrarySession {
					export class Builder extends androidx.media2.session.MediaSession.BuilderBase<androidx.media2.session.MediaLibraryService.MediaLibrarySession,androidx.media2.session.MediaLibraryService.MediaLibrarySession.Builder,androidx.media2.session.MediaLibraryService.MediaLibrarySession.MediaLibrarySessionCallback> {
						...
						public setThrowsWhenInvalidReturn(throwsWhenInvalidReturn: boolean): androidx.media2.session.MediaLibraryService.MediaLibrarySession.Builder;
...
declare module androidx {
	export module media2 {
		export module session {
			export class MediaSessionLegacyStub extends globalAndroid.support.v4.media.session.MediaSessionCompat.Callback implements java.io.Closeable {
		...
		export module session {
			...
			export module MediaSessionStub {
				...
				export class LibrarySessionCallbackTask<T>  extends androidx.media2.session.MediaSessionStub.SessionTask {
					 ...
					 */
					public constructor(implementation: {
						run(mediaLibrarySessionImpl0: androidx.media2.session.MediaLibraryService.MediaLibrarySession.MediaLibrarySessionImpl, controllerInfo1: androidx.media2.session.MediaSession.ControllerInfo): any;
					});
					public constructor();
					public run(mediaLibrarySessionImpl0: androidx.media2.session.MediaLibraryService.MediaLibrarySession.MediaLibrarySessionImpl, controllerInfo1: androidx.media2.session.MediaSession.ControllerInfo): any;
				}
				export class SessionCallbackTask<T>  extends androidx.media2.session.MediaSessionStub.SessionTask {
					 ...
					 */
					public constructor(implementation: {
						run(mediaSessionImpl0: androidx.media2.session.MediaSession.MediaSessionImpl, controllerInfo1: androidx.media2.session.MediaSession.ControllerInfo): any;
					});
					public constructor();
					public run(mediaSessionImpl0: androidx.media2.session.MediaSession.MediaSessionImpl, controllerInfo1: androidx.media2.session.MediaSession.ControllerInfo): any;
				}
				export class SessionPlayerTask extends java.lang.Object implements androidx.media2.session.MediaSessionStub.SessionTask {
					 ...
					 */
					public constructor(implementation: {
						run(mediaSessionImpl0: androidx.media2.session.MediaSession.MediaSessionImpl, controllerInfo1: androidx.media2.session.MediaSession.ControllerInfo): com.google.common.util.concurrent.ListenableFuture<androidx.media2.common.SessionPlayer.PlayerResult>;
					});
					public constructor();
					public run(mediaSessionImpl0: androidx.media2.session.MediaSession.MediaSessionImpl, controllerInfo1: androidx.media2.session.MediaSession.ControllerInfo): com.google.common.util.concurrent.ListenableFuture<androidx.media2.common.SessionPlayer.PlayerResult>;
				}
				export class SessionTask extends java.lang.Object {
	...
	export module media2 {
		export module session {
			export class MediaUtils extends java.lang.Object {
				...
				public static getLegacyStreamType(attrs: androidx.media.AudioAttributesCompat): number;
				...
				public static convertToMediaItem(metadataCompat: globalAndroid.support.v4.media.MediaMetadataCompat, ratingType: number): androidx.media2.common.MediaItem;
