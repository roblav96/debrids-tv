		...
		export module android {
			export module exoplayer2 {
				export module transformer {
					...
					export module MediaCodecAdapterWrapper {
						export class Factory extends com.google.android.exoplayer2.mediacodec.SynchronousMediaCodecAdapter.Factory {
							public static class: java.lang.Class<com.google.android.exoplayer2.transformer.MediaCodecAdapterWrapper.Factory>;
							public constructor();
							public createCodec(configuration: com.google.android.exoplayer2.mediacodec.MediaCodecAdapter.Configuration): globalAndroid.media.MediaCodec;
							public constructor(decoder: boolean);
							public createAdapter(configuration: com.google.android.exoplayer2.mediacodec.MediaCodecAdapter.Configuration): com.google.android.exoplayer2.mediacodec.MediaCodecAdapter;
						}
					}
				}
			}
				...
				export module transformer {
					...
					export module Transformer {
						...
						export class TransformerAnalyticsListener extends java.lang.Object implements com.google.android.exoplayer2.analytics.AnalyticsListener {
							...
							public onAudioDisabled(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, decoderCounters: com.google.android.exoplayer2.decoder.DecoderCounters): void;
							...
							public onAudioCodecError(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, audioCodecError: java.lang.Exception): void;
							...
							public onDrmSessionAcquired(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, state: number): void;
							public onVideoSizeChanged(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, videoSize: com.google.android.exoplayer2.video.VideoSize): void;
							/** @deprecated */
							...
							public onMediaMetadataChanged(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, mediaMetadata: com.google.android.exoplayer2.MediaMetadata): void;
							...
							public onVideoDecoderInitialized(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, decoderName: string, initializedTimestampMs: number, initializationDurationMs: number): void;
							...
							public onAudioDecoderInitialized(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, decoderName: string, initializedTimestampMs: number, initializationDurationMs: number): void;
							/** @deprecated */
							...
							public onPlaylistMetadataChanged(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, playlistMetadata: com.google.android.exoplayer2.MediaMetadata): void;
							...
							public onSeekForwardIncrementChanged(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, seekForwardIncrementMs: number): void;
							...
							public onVideoEnabled(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, decoderCounters: com.google.android.exoplayer2.decoder.DecoderCounters): void;
							/** @deprecated */
							...
							public onMaxSeekToPreviousPositionChanged(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, maxSeekToPreviousPositionMs: number): void;
							public onPlayerError(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, error: com.google.android.exoplayer2.PlaybackException): void;
							...
							public onVideoDisabled(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, decoderCounters: com.google.android.exoplayer2.decoder.DecoderCounters): void;
							public onVideoCodecError(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, videoCodecError: java.lang.Exception): void;
							public onPositionDiscontinuity(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, oldPosition: com.google.android.exoplayer2.Player.PositionInfo, newPosition: com.google.android.exoplayer2.Player.PositionInfo, reason: number): void;
							public onAudioEnabled(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, decoderCounters: com.google.android.exoplayer2.decoder.DecoderCounters): void;
							...
							public onRenderedFirstFrame(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, output: any, renderTimeMs: number): void;
							public onSeekBackIncrementChanged(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, seekBackIncrementMs: number): void;
							/** @deprecated */
							...
							public onAvailableCommandsChanged(eventTime: com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime, availableCommands: com.google.android.exoplayer2.Player.Commands): void;
						}
