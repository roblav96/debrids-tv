				...
				export module ext {
					export module mediasession {
						export class MediaSessionConnector extends java.lang.Object {
							...
							public setDispatchUnsupportedActionsEnabled(dispatchUnsupportedActionsEnabled: boolean): void;
							...
							public setMetadataDeduplicationEnabled(metadataDeduplicationEnabled: boolean): void;
						...
						export module MediaSessionConnector {
							...
							export class ComponentListener extends globalAndroid.support.v4.media.session.MediaSessionCompat.Callback implements com.google.android.exoplayer2.Player.Listener {
							...
							export class DefaultMediaMetadataProvider extends java.lang.Object implements com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaMetadataProvider {
								...
								public sameAs(oldMetadata: globalAndroid.support.v4.media.MediaMetadataCompat, newMetadata: globalAndroid.support.v4.media.MediaMetadataCompat): boolean;
							}
							...
							export class MediaMetadataProvider extends java.lang.Object {
								...
								public constructor(implementation: {
									...
									sameAs(oldMetadata: globalAndroid.support.v4.media.MediaMetadataCompat, newMetadata: globalAndroid.support.v4.media.MediaMetadataCompat): boolean;
								});
								public constructor();
				...
				export module ext {
					export module mediasession {
						export class TimelineQueueEditor extends java.lang.Object implements com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueEditor, com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver {
							...
							public constructor(mediaController: globalAndroid.support.v4.media.session.MediaControllerCompat, queueDataAdapter: com.google.android.exoplayer2.ext.mediasession.TimelineQueueEditor.QueueDataAdapter, mediaDescriptionConverter: com.google.android.exoplayer2.ext.mediasession.TimelineQueueEditor.MediaDescriptionConverter);
							...
							public constructor(mediaController: globalAndroid.support.v4.media.session.MediaControllerCompat, queueDataAdapter: com.google.android.exoplayer2.ext.mediasession.TimelineQueueEditor.QueueDataAdapter, mediaDescriptionConverter: com.google.android.exoplayer2.ext.mediasession.TimelineQueueEditor.MediaDescriptionConverter, equalityChecker: com.google.android.exoplayer2.ext.mediasession.TimelineQueueEditor.MediaDescriptionEqualityChecker);
						...
						export module TimelineQueueEditor {
							export class MediaDescriptionConverter extends java.lang.Object {
								public static class: java.lang.Class<com.google.android.exoplayer2.ext.mediasession.TimelineQueueEditor.MediaDescriptionConverter>;
								/**
								 ...
								 */
								public constructor(implementation: {
									convert(mediaDescriptionCompat0: globalAndroid.support.v4.media.MediaDescriptionCompat): com.google.android.exoplayer2.MediaItem;
								});
								public constructor();
								public convert(mediaDescriptionCompat0: globalAndroid.support.v4.media.MediaDescriptionCompat): com.google.android.exoplayer2.MediaItem;
							}
