				...
				export module source {
					export module hls {
						export class DefaultHlsExtractorFactory extends java.lang.Object implements com.google.android.exoplayer2.source.hls.HlsExtractorFactory {
							...
							public createExtractor(uri: globalAndroid.net.Uri, format: com.google.android.exoplayer2.Format, muxedCaptionFormats: java.util.List<com.google.android.exoplayer2.Format>, timestampAdjuster: com.google.android.exoplayer2.util.TimestampAdjuster, responseHeaders: java.util.Map<string,java.util.List<string>>, sniffingExtractorInput: com.google.android.exoplayer2.extractor.ExtractorInput): com.google.android.exoplayer2.source.hls.BundledHlsMediaChunkExtractor;
						}
					}
				}
			}
				...
				export module source {
					export module hls {
						export class HlsChunkSource extends java.lang.Object {
							...
							public obtainsChunksForPlaylist(playlistUrl: globalAndroid.net.Uri): boolean;
						...
						export module HlsChunkSource {
							...
							export class InitializationTrackSelection extends com.google.android.exoplayer2.trackselection.BaseTrackSelection {
								...
								public constructor(group: com.google.android.exoplayer2.source.TrackGroup, tracks: native.Array<number>, type: number);
				...
				export module source {
					export module hls {
						export class HlsMediaChunk extends com.google.android.exoplayer2.source.chunk.MediaChunk {
							...
							public cancelLoad(): void;
							public static shouldSpliceIn(previousChunk: com.google.android.exoplayer2.source.hls.HlsMediaChunk, playlistUrl: globalAndroid.net.Uri, mediaPlaylist: com.google.android.exoplayer2.source.hls.playlist.HlsMediaPlaylist, segmentBaseHolder: com.google.android.exoplayer2.source.hls.HlsChunkSource.SegmentBaseHolder, startOfPlaylistInPeriodUs: number): boolean;
							public load(): void;
							...
							public static createInstance(extractorFactory: com.google.android.exoplayer2.source.hls.HlsExtractorFactory, dataSource: com.google.android.exoplayer2.upstream.DataSource, format: com.google.android.exoplayer2.Format, startOfPlaylistInPeriodUs: number, mediaPlaylist: com.google.android.exoplayer2.source.hls.playlist.HlsMediaPlaylist, segmentBaseHolder: com.google.android.exoplayer2.source.hls.HlsChunkSource.SegmentBaseHolder, playlistUrl: globalAndroid.net.Uri, muxedCaptionFormats: java.util.List<com.google.android.exoplayer2.Format>, trackSelectionReason: number, trackSelectionData: any, isMasterTimestampSource: boolean, timestampAdjusterProvider: com.google.android.exoplayer2.source.hls.TimestampAdjusterProvider, previousChunk: com.google.android.exoplayer2.source.hls.HlsMediaChunk, mediaSegmentKey: native.Array<number>, initSegmentKey: native.Array<number>, shouldSpliceIn: boolean): com.google.android.exoplayer2.source.hls.HlsMediaChunk;
				...
				export module source {
					export module hls {
						export class HlsMediaPeriod extends java.lang.Object implements com.google.android.exoplayer2.source.MediaPeriod, com.google.android.exoplayer2.source.hls.HlsSampleStreamWrapper.Callback, com.google.android.exoplayer2.source.hls.playlist.HlsPlaylistTracker.PlaylistEventListener {
							...
							public onPlaylistError(url: globalAndroid.net.Uri, loadErrorInfo: com.google.android.exoplayer2.upstream.LoadErrorHandlingPolicy.LoadErrorInfo, forceRetry: boolean): boolean;
				...
				export module source {
					export module hls {
						export class HlsMediaSource extends com.google.android.exoplayer2.source.BaseMediaSource implements com.google.android.exoplayer2.source.hls.playlist.HlsPlaylistTracker.PrimaryPlaylistListener {
							...
							public onPrimaryPlaylistRefreshed(mediaPlaylist: com.google.android.exoplayer2.source.hls.playlist.HlsMediaPlaylist): void;
						}
				...
				export module source {
					export module hls {
						export class HlsSampleStreamWrapper extends java.lang.Object {
							...
							public onPlaylistError(playlistUrl: globalAndroid.net.Uri, loadErrorInfo: com.google.android.exoplayer2.upstream.LoadErrorHandlingPolicy.LoadErrorInfo, forceRetry: boolean): boolean;
							public getTrackGroups(): com.google.android.exoplayer2.source.TrackGroupArray;
							...
							public readData(sampleQueueIndex: number, formatHolder: com.google.android.exoplayer2.FormatHolder, buffer: com.google.android.exoplayer2.decoder.DecoderInputBuffer, readFlags: number): number;
					...
					export module hls {
						export module playlist {
							export class DefaultHlsPlaylistTracker extends java.lang.Object {
								...
								public excludeMediaPlaylist(playlistUrl: globalAndroid.net.Uri, exclusionDurationMs: number): boolean;
							...
							export module DefaultHlsPlaylistTracker {
								export class FirstPrimaryMediaPlaylistListener extends java.lang.Object implements com.google.android.exoplayer2.source.hls.playlist.HlsPlaylistTracker.PlaylistEventListener {
									public static class: java.lang.Class<com.google.android.exoplayer2.source.hls.playlist.DefaultHlsPlaylistTracker.FirstPrimaryMediaPlaylistListener>;
									public onPlaylistError(url: globalAndroid.net.Uri, loadErrorInfo: com.google.android.exoplayer2.upstream.LoadErrorHandlingPolicy.LoadErrorInfo, forceRetry: boolean): boolean;
									public onPlaylistChanged(): void;
								}
					...
					export module hls {
						export module playlist {
							export class HlsMediaPlaylist extends com.google.android.exoplayer2.source.hls.playlist.HlsPlaylist {
								...
								public hasPositiveStartOffset: boolean;
								public preciseStart: boolean;
								...
								public constructor(playlistType: number, baseUri: string, tags: java.util.List<string>, startOffsetUs: number, preciseStart: boolean, startTimeUs: number, hasDiscontinuitySequence: boolean, discontinuitySequence: number, mediaSequence: number, version: number, targetDurationUs: number, partTargetDurationUs: number, hasIndependentSegments: boolean, hasEndTag: boolean, hasProgramDateTime: boolean, protectionSchemes: com.google.android.exoplayer2.drm.DrmInitData, segments: java.util.List<com.google.android.exoplayer2.source.hls.playlist.HlsMediaPlaylist.Segment>, trailingParts: java.util.List<com.google.android.exoplayer2.source.hls.playlist.HlsMediaPlaylist.Part>, serverControl: com.google.android.exoplayer2.source.hls.playlist.HlsMediaPlaylist.ServerControl, renditionReports: java.util.Map<globalAndroid.net.Uri,com.google.android.exoplayer2.source.hls.playlist.HlsMediaPlaylist.RenditionReport>);
						...
						export module playlist {
							export class HlsPlaylistTracker extends java.lang.Object {
								...
								public constructor(implementation: {
									...
									excludeMediaPlaylist(uri0: globalAndroid.net.Uri, long1: number): boolean;
								...
								public excludeMediaPlaylist(uri0: globalAndroid.net.Uri, long1: number): boolean;
							...
							export module HlsPlaylistTracker {
								...
								export class PlaylistEventListener extends java.lang.Object {
									...
									public constructor(implementation: {
										...
										onPlaylistError(uri0: globalAndroid.net.Uri, loadErrorInfo1: com.google.android.exoplayer2.upstream.LoadErrorHandlingPolicy.LoadErrorInfo, boolean2: boolean): boolean;
									});
									public constructor();
									public onPlaylistChanged(): void;
									public onPlaylistError(uri0: globalAndroid.net.Uri, loadErrorInfo1: com.google.android.exoplayer2.upstream.LoadErrorHandlingPolicy.LoadErrorInfo, boolean2: boolean): boolean;
								}
