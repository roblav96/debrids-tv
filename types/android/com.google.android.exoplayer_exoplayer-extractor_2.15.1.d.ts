			...
			export module exoplayer2 {
				export module extractor {
					export class ExtractorUtil extends java.lang.Object {
						...
						public static checkContainerInput(expression: boolean, message: string): void;
						public static skipFullyQuietly(input: com.google.android.exoplayer2.extractor.ExtractorInput, length: number): boolean;
						public static peekFullyQuietly(input: com.google.android.exoplayer2.extractor.ExtractorInput, output: native.Array<number>, offset: number, length: number, allowEndOfInput: boolean): boolean;
						...
						public static readFullyQuietly(input: com.google.android.exoplayer2.extractor.ExtractorInput, output: native.Array<number>, offset: number, length: number): boolean;
					}
				}
			}
		}
				...
				export module extractor {
					export module mp4 {
						export abstract class Atom extends java.lang.Object {
							...
							public static TYPE_colr: number;
							...
							public static TYPE_H263: number;
							...
							public static TYPE_mha1: number;
							public static TYPE_mhm1: number;
							public static TYPE_mhaC: number;
							...
							public static TYPE_dtsx: number;
				...
				export module extractor {
					export module ts {
						export class TsUtil extends java.lang.Object {
							...
							public static isStartOfTsPacket(data: native.Array<number>, start: number, limit: number, searchPosition: number): boolean;
