			...
			export module media {
				...
				export module MediaBrowserCompat {
					export class Api21Impl extends java.lang.Object {
						public static class: java.lang.Class<android.support.v4.media.MediaBrowserCompat.Api21Impl>;
					}
					...
					export module ConnectionCallback {
						...
						export class ConnectionCallbackInternal extends java.lang.Object {
							...
							/**
							 * Constructs a new instance of the android.support.v4.media.MediaBrowserCompat() when extending the interface class.
							 */
					...
					export class MediaBrowserImplApi21 extends java.lang.Object implements android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl, android.support.v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl, android.support.v4.media.MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal {
						...
						public onLoadChildren(callback: android.os.Messenger, parentId: string, list: java.util.List<android.support.v4.media.MediaBrowserCompat.MediaItem>, options: android.os.Bundle, notifyChildrenChangedOptions: android.os.Bundle): void;
						public isConnected(): boolean;
						public getItem(mediaId: string, cb: android.support.v4.media.MediaBrowserCompat.ItemCallback): void;
						public connect(): void;
						public disconnect(): void;
					...
					export class MediaBrowserServiceCallbackImpl extends java.lang.Object {
						...
						public constructor(implementation: {
							...
							onLoadChildren(messenger0: android.os.Messenger, string1: string, list2: java.util.List<android.support.v4.media.MediaBrowserCompat.MediaItem>, bundle3: android.os.Bundle, bundle4: android.os.Bundle): void;
						});
						public constructor();
						public onLoadChildren(messenger0: android.os.Messenger, string1: string, list2: java.util.List<android.support.v4.media.MediaBrowserCompat.MediaItem>, bundle3: android.os.Bundle, bundle4: android.os.Bundle): void;
		...
		export module v4 {
			export module media {
				...
				export module MediaDescriptionCompat {
					export class Api21Impl extends java.lang.Object {
						public static class: java.lang.Class<android.support.v4.media.MediaDescriptionCompat.Api21Impl>;
					}
					export class Api23Impl extends java.lang.Object {
						public static class: java.lang.Class<android.support.v4.media.MediaDescriptionCompat.Api23Impl>;
					}
			...
			export module media {
				...
				export module RatingCompat {
					export class Api19Impl extends java.lang.Object {
						public static class: java.lang.Class<android.support.v4.media.RatingCompat.Api19Impl>;
					}
					export class StarStyle extends java.lang.Object implements java.lang.annotation.Annotation {
						...
						/**
						 * Constructs a new instance of the android.support.v4.media.RatingCompat() when extending the interface class.
						 */
						public constructor(implementation: {
			...
			export module media {
				export module session {
					...
					export module IMediaControllerCallback {
						export class Default extends java.lang.Object implements android.support.v4.media.session.IMediaControllerCallback {
							public static class: java.lang.Class<android.support.v4.media.session.IMediaControllerCallback.Default>;
							public constructor();
						...
						export abstract class Stub extends android.os.Binder implements android.support.v4.media.session.IMediaControllerCallback {
							...
							public asBinder(): android.os.IBinder;
							public static setDefaultImpl(impl: android.support.v4.media.session.IMediaControllerCallback): boolean;
							public constructor();
							public onEvent(string0: string, bundle1: android.os.Bundle): void;
							public static asInterface(obj: android.os.IBinder): android.support.v4.media.session.IMediaControllerCallback;
							public static getDefaultImpl(): android.support.v4.media.session.IMediaControllerCallback;
							public onExtrasChanged(bundle0: android.os.Bundle): void;
						...
						export module Stub {
							export class Proxy extends java.lang.Object implements android.support.v4.media.session.IMediaControllerCallback {
								...
								public static sDefaultImpl: android.support.v4.media.session.IMediaControllerCallback;
								public onExtrasChanged(extras: android.os.Bundle): void;
								public onRepeatModeChanged(repeatMode: number): void;
								public onCaptioningEnabledChanged(enabled: boolean): void;
								public onShuffleModeChangedRemoved(enabled: boolean): void;
			...
			export module media {
				export module session {
					...
					export module IMediaSession {
						export class Default extends java.lang.Object implements android.support.v4.media.session.IMediaSession {
							public static class: java.lang.Class<android.support.v4.media.session.IMediaSession.Default>;
							public next(): void;
							public getSessionInfo(): android.os.Bundle;
						...
						export abstract class Stub extends android.os.Binder implements android.support.v4.media.session.IMediaSession {
							...
							public setShuffleMode(int0: number): void;
							public getQueueTitle(): string;
							public static setDefaultImpl(impl: android.support.v4.media.session.IMediaSession): boolean;
							public getVolumeAttributes(): android.support.v4.media.session.ParcelableVolumeInfo;
							public setShuffleModeEnabledRemoved(boolean0: boolean): void;
							public transact(code: number, data: android.os.Parcel, reply: android.os.Parcel, flags: number): boolean;
							public getMetadata(): android.support.v4.media.MediaMetadataCompat;
							...
							public playFromUri(uri0: android.net.Uri, bundle1: android.os.Bundle): void;
							public dump(fd: java.io.FileDescriptor, strings1: native.Array<string>): void;
							public static getDefaultImpl(): android.support.v4.media.session.IMediaSession;
							public linkToDeath(recipient: android.os.IBinder.DeathRecipient, flags: number): void;
							public asBinder(): android.os.IBinder;
						...
						export module Stub {
							export class Proxy extends java.lang.Object implements android.support.v4.media.session.IMediaSession {
								...
								public static sDefaultImpl: android.support.v4.media.session.IMediaSession;
								public next(): void;
								public getMetadata(): android.support.v4.media.MediaMetadataCompat;
								public setCaptioningEnabled(enabled: boolean): void;
								public getShuffleMode(): number;
				...
				export module session {
					...
					export module MediaControllerCompat {
						...
						export class MediaControllerImpl extends java.lang.Object {
							...
							/**
							 * Constructs a new instance of the android.support.v4.media.session.MediaControllerCompat() when extending the interface class.
							 */
							public constructor(implementation: {
						...
						export class MediaControllerImplApi21 extends java.lang.Object implements android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl {
							...
							public mSessionInfo: android.os.Bundle;
							public getSessionInfo(): android.os.Bundle;
							public addQueueItem(description: android.support.v4.media.MediaDescriptionCompat, index: number): void;
							public isCaptioningEnabled(): boolean;
							public getMediaController(): any;
						...
						export class MediaControllerImplApi29 extends android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21 {
							public static class: java.lang.Class<android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi29>;
							public getSessionInfo(): android.os.Bundle;
							public addQueueItem(description: android.support.v4.media.MediaDescriptionCompat, index: number): void;
							public isCaptioningEnabled(): boolean;
							public getMediaController(): any;
						...
						export class TransportControlsApi29 extends android.support.v4.media.session.MediaControllerCompat.TransportControlsApi24 {
							public static class: java.lang.Class<android.support.v4.media.session.MediaControllerCompat.TransportControlsApi29>;
							public setPlaybackSpeed(speed: number): void;
						}
			...
			export module media {
				export module session {
					export class MediaSessionCompat extends java.lang.Object {
						...
						public static PENDING_INTENT_FLAG_MUTABLE: number;
						...
						public setCaptioningEnabled(enabled: boolean): void;
						public static unparcelWithClassLoader(bundle: android.os.Bundle): android.os.Bundle;
					...
					export module MediaSessionCompat {
						...
						export class MediaSessionImpl extends java.lang.Object {
							...
							/**
							 * Constructs a new instance of the android.support.v4.media.session.MediaSessionCompat() when extending the interface class.
							 */
							public constructor(implementation: {
								...
								getCallback(): android.support.v4.media.session.MediaSessionCompat.Callback;
							});
							public constructor();
							public getSessionToken(): android.support.v4.media.session.MediaSessionCompat.Token;
							...
							public getCallback(): android.support.v4.media.session.MediaSessionCompat.Callback;
						...
						export class MediaSessionImplApi21 extends java.lang.Object implements android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl {
							...
							public setQueueTitle(title: string): void;
							public getRemoteControlClient(): any;
							public createFwkMediaSession(context: android.content.Context, tag: string, sessionInfo: android.os.Bundle): any;
							public sendSessionEvent(event: string, extras: android.os.Bundle): void;
						}
						...
						export class MediaSessionImplApi22 extends android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21 {
							public static class: java.lang.Class<android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi22>;
							public getSessionToken(): android.support.v4.media.session.MediaSessionCompat.Token;
							public setRatingType(type: number): void;
							public setFlags(flags: number): void;
							public setExtras(extras: android.os.Bundle): void;
						...
						export class MediaSessionImplApi28 extends android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi22 {
						...
						export class MediaSessionImplApi29 extends android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi28 {
							public static class: java.lang.Class<android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi29>;
							public getSessionToken(): android.support.v4.media.session.MediaSessionCompat.Token;
							public setRatingType(type: number): void;
							public setFlags(flags: number): void;
							public setExtras(extras: android.os.Bundle): void;
						...
						export class MediaSessionImplBase extends java.lang.Object implements android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl {
							...
							public setPlaybackToRemote(volumeProvider: androidx.media.VolumeProviderCompat): void;
							public setRepeatMode(repeatMode: number): void;
							public constructor(context: android.content.Context, tag: string, mbrComponent: android.content.ComponentName, mbrIntent: android.app.PendingIntent, session2Token: androidx.versionedparcelable.VersionedParcelable, sessionInfo: android.os.Bundle);
							public setCurrentControllerInfo(remoteUserInfo: androidx.media.MediaSessionManager.RemoteUserInfo): void;
							public setPlaybackToLocal(stream: number): void;
							public setSessionActivity(pi: android.app.PendingIntent): void;
							public getMediaSession(): any;
						...
						export module QueueItem {
							export class Api21Impl extends java.lang.Object {
								public static class: java.lang.Class<android.support.v4.media.session.MediaSessionCompat.QueueItem.Api21Impl>;
							}
						}
				...
				export module session {
					...
					export module PlaybackStateCompat {
						export class Actions extends java.lang.Object implements java.lang.annotation.Annotation {
							...
							/**
							 * Constructs a new instance of the android.support.v4.media.session.PlaybackStateCompat() when extending the interface class.
							 */
							public constructor(implementation: {
								equals(object0: any): boolean;
								hashCode(): number;
						...
						export class Api21Impl extends java.lang.Object {
							public static class: java.lang.Class<android.support.v4.media.session.PlaybackStateCompat.Api21Impl>;
						}
						export class Api22Impl extends java.lang.Object {
							public static class: java.lang.Class<android.support.v4.media.session.PlaybackStateCompat.Api22Impl>;
						}
						export class Builder extends java.lang.Object {
	...
	export module media {
		...
		export module AudioAttributesCompat {
			export class AttributeContentType extends java.lang.Object implements java.lang.annotation.Annotation {
				...
				/**
				 * Constructs a new instance of the androidx.media.AudioAttributesCompat() when extending the interface class.
				 */
				public constructor(implementation: {
					equals(object0: any): boolean;
					hashCode(): number;
	...
	export module media {
		...
		export module AudioAttributesImpl {
			export class Builder extends java.lang.Object {
				...
				/**
				 * Constructs a new instance of the androidx.media.AudioAttributesImpl() when extending the interface class.
				 */
				public constructor(implementation: {
	...
	export module media {
		...
		export module AudioFocusRequestCompat {
			export class Api26Impl extends java.lang.Object {
				public static class: java.lang.Class<androidx.media.AudioFocusRequestCompat.Api26Impl>;
			}
			export class Builder extends java.lang.Object {
...
declare module androidx {
	export module media {
		export class AudioManagerCompat extends java.lang.Object {
			...
			public static getStreamMaxVolume(audioManager: globalAndroid.media.AudioManager, streamType: number): number;
			public static getStreamMinVolume(audioManager: globalAndroid.media.AudioManager, streamType: number): number;
		}
		export module AudioManagerCompat {
			export class Api26Impl extends java.lang.Object {
				public static class: java.lang.Class<androidx.media.AudioManagerCompat.Api26Impl>;
			}
			export class Api28Impl extends java.lang.Object {
				public static class: java.lang.Class<androidx.media.AudioManagerCompat.Api28Impl>;
			}
		}
	}
}
	...
	export module media {
		...
		export module MediaBrowserServiceCompat {
			...
			export class MediaBrowserServiceImpl extends java.lang.Object {
				...
				/**
				 * Constructs a new instance of the androidx.media.MediaBrowserServiceCompat() when extending the interface class.
				 */
				public constructor(implementation: {
					onCreate(): void;
	...
	export module media {
		...
		export module MediaSessionManager {
			export class MediaSessionManagerImpl extends java.lang.Object {
				...
				/**
				 * Constructs a new instance of the androidx.media.MediaSessionManager() when extending the interface class.
				 */
				public constructor(implementation: {
...
declare module androidx {
	export module media {
		export abstract class VolumeProviderCompat extends java.lang.Object {
			...
			public getVolumeControl(): number;
			public constructor(volumeControl: number, maxVolume: number, currentVolume: number, volumeControlId: string);
			...
			public getVolumeControlId(): string;
		}
		export module VolumeProviderCompat {
			export class Api21Impl extends java.lang.Object {
				public static class: java.lang.Class<androidx.media.VolumeProviderCompat.Api21Impl>;
			}
			export abstract class Callback extends java.lang.Object {
			...
			export class ControlType extends java.lang.Object implements java.lang.annotation.Annotation {
				...
				/**
				 * Constructs a new instance of the androidx.media.VolumeProviderCompat() when extending the interface class.
				 */
				public constructor(implementation: {
					equals(object0: any): boolean;
					hashCode(): number;
		...
		export module app {
			...
			export module NotificationCompat {
				export class Api15Impl extends java.lang.Object {
					public static class: java.lang.Class<androidx.media.app.NotificationCompat.Api15Impl>;
				}
				export class Api21Impl extends java.lang.Object {
					public static class: java.lang.Class<androidx.media.app.NotificationCompat.Api21Impl>;
				}
				export class Api24Impl extends java.lang.Object {
					public static class: java.lang.Class<androidx.media.app.NotificationCompat.Api24Impl>;
				}
	...
	export module media {
		export module utils {
			export class MediaConstants extends java.lang.Object {
				public static class: java.lang.Class<androidx.media.utils.MediaConstants>;
				public static SESSION_EXTRAS_KEY_ACCOUNT_NAME: string;
				public static SESSION_EXTRAS_KEY_ACCOUNT_TYPE: string;
				public static SESSION_EXTRAS_KEY_AUTHTOKEN: string;
				public static SESSION_EXTRAS_KEY_SLOT_RESERVATION_SKIP_TO_NEXT: string;
				public static SESSION_EXTRAS_KEY_SLOT_RESERVATION_SKIP_TO_PREV: string;
				public static METADATA_KEY_CONTENT_ID: string;
				public static METADATA_KEY_NEXT_EPISODE_CONTENT_ID: string;
				public static METADATA_KEY_SERIES_CONTENT_ID: string;
				public static METADATA_KEY_IS_EXPLICIT: string;
				public static METADATA_KEY_IS_ADVERTISEMENT: string;
				public static METADATA_VALUE_ATTRIBUTE_PRESENT: number;
				public static BROWSER_ROOT_HINTS_KEY_ROOT_CHILDREN_LIMIT: string;
				public static BROWSER_ROOT_HINTS_KEY_ROOT_CHILDREN_SUPPORTED_FLAGS: string;
				public static BROWSER_ROOT_HINTS_KEY_MEDIA_ART_SIZE_PIXELS: string;
				public static BROWSER_SERVICE_EXTRAS_KEY_SEARCH_SUPPORTED: string;
				public static DESCRIPTION_EXTRAS_KEY_CONTENT_STYLE_PLAYABLE: string;
				public static DESCRIPTION_EXTRAS_KEY_CONTENT_STYLE_BROWSABLE: string;
				public static DESCRIPTION_EXTRAS_VALUE_CONTENT_STYLE_LIST_ITEM: number;
				public static DESCRIPTION_EXTRAS_VALUE_CONTENT_STYLE_GRID_ITEM: number;
				public static DESCRIPTION_EXTRAS_VALUE_CONTENT_STYLE_CATEGORY_LIST_ITEM: number;
				public static DESCRIPTION_EXTRAS_VALUE_CONTENT_STYLE_CATEGORY_GRID_ITEM: number;
				public static DESCRIPTION_EXTRAS_KEY_CONTENT_STYLE_GROUP_TITLE: string;
				public static DESCRIPTION_EXTRAS_KEY_COMPLETION_STATUS: string;
				public static DESCRIPTION_EXTRAS_VALUE_COMPLETION_STATUS_NOT_PLAYED: number;
				public static DESCRIPTION_EXTRAS_VALUE_COMPLETION_STATUS_PARTIALLY_PLAYED: number;
				public static DESCRIPTION_EXTRAS_VALUE_COMPLETION_STATUS_FULLY_PLAYED: number;
				public static PLAYBACK_STATE_EXTRAS_KEY_MEDIA_ID: string;
				public static PLAYBACK_STATE_EXTRAS_KEY_ERROR_RESOLUTION_ACTION_LABEL: string;
				public static PLAYBACK_STATE_EXTRAS_KEY_ERROR_RESOLUTION_ACTION_INTENT: string;
				public static TRANSPORT_CONTROLS_EXTRAS_KEY_LEGACY_STREAM_TYPE: string;
				public static TRANSPORT_CONTROLS_EXTRAS_KEY_SHUFFLE: string;
			}
		}
	}
}
