...
declare module androidx {
	export module media2 {
		export module common {
			export class ClassVerificationHelper extends java.lang.Object {
				public static class: java.lang.Class<androidx.media2.common.ClassVerificationHelper>;
			}
			export module ClassVerificationHelper {
				export class AudioManager extends java.lang.Object {
					public static class: java.lang.Class<androidx.media2.common.ClassVerificationHelper.AudioManager>;
				}
				export module AudioManager {
					export class Api21 extends java.lang.Object {
						public static class: java.lang.Class<androidx.media2.common.ClassVerificationHelper.AudioManager.Api21>;
						public static isVolumeFixed(manager: globalAndroid.media.AudioManager): boolean;
					}
				}
				export class HandlerThread extends java.lang.Object {
					public static class: java.lang.Class<androidx.media2.common.ClassVerificationHelper.HandlerThread>;
				}
				export module HandlerThread {
					export class Api18 extends java.lang.Object {
						public static class: java.lang.Class<androidx.media2.common.ClassVerificationHelper.HandlerThread.Api18>;
						public static quitSafely(handlerThread: globalAndroid.os.HandlerThread): boolean;
					}
				}
				export class PendingIntent extends java.lang.Object {
					public static class: java.lang.Class<androidx.media2.common.ClassVerificationHelper.PendingIntent>;
				}
				export module PendingIntent {
					export class Api26 extends java.lang.Object {
						public static class: java.lang.Class<androidx.media2.common.ClassVerificationHelper.PendingIntent.Api26>;
						public static getForegroundService(context: globalAndroid.content.Context, requestCode: number, intent: globalAndroid.content.Intent, flags: number): globalAndroid.app.PendingIntent;
					}
				}
			}
		}
		...
		export module common {
			...
			export module MediaItem {
				...
				export class OnMetadataChangedListener extends java.lang.Object {
					...
					/**
					 * Constructs a new instance of the androidx.media2.common.MediaItem() when extending the interface class.
					 */
					public constructor(implementation: {
		...
		export module common {
			...
			export module MediaMetadata {
				...
				export class BitmapKey extends java.lang.Object implements java.lang.annotation.Annotation {
					...
					/**
					 * Constructs a new instance of the androidx.media2.common.MediaMetadata() when extending the interface class.
					 */
					public constructor(implementation: {
		...
		export module common {
			...
			export module SessionPlayer {
				export class BuffState extends java.lang.Object implements java.lang.annotation.Annotation {
					...
					/**
					 * Constructs a new instance of the androidx.media2.common.SessionPlayer() when extending the interface class.
					 */
					public constructor(implementation: {
						equals(object0: any): boolean;
						hashCode(): number;
